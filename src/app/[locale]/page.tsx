    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section id="clients" className="w-full py-12 md:py-24">
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-2 items-start gap-8 pt-12 sm:grid-cols-3 lg:grid-cols-6 lg:gap-12 text-center">
      ...
      <section id="contacts" className="w-full py-12 md:py-24">
        <div className="container px-4 md:px-6">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 gap-12 items-center text-center">
