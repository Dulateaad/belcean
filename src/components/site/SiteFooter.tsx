...
import { PHONE_DISPLAY, PHONE_TEL_HREF, TELEGRAM_HREF, WHATSAPP_HREF } from '@/lib/contact-links';
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <p>
               ...
               <div className="flex space-x-4 pt-4 justify-center md:justify-start">
                <Link href={WHATSAPP_HREF} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-[#25D366] hover:opacity-80">
