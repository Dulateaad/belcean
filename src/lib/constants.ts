...
export const getServices = (t: any) => {
    ...
    return [
      { slug: servicesText[0].slug, title: servicesText[0].title, description: servicesText[0].description, icon: Building2, cardImage: '/services/tashkent-card.jpg', imageId: 'service-office', imageHint: 'clean office' },
